...
public class MainGUI {
	...
	private void initialize() {
		...
		btnGo.addActionListener(new ActionListener() {
			...
			public void execute() {
				Main.initialCopDensity = Double.valueOf(cop.getText());
				Main.initialCitizenDensity = Double.valueOf(agent.getText());
				Main.vision = Double.valueOf(vis.getText());
				Main.governmentLegitimacy = Double.valueOf(glegi.getText());
				Main.maxJailTerm = Integer.valueOf(mjt.getText());
				stopMain = false;
				btnStop.setEnabled(true);
				btnGo.setEnabled(false);
				Main.stopMainValue = Boolean.valueOf(stopMain);
